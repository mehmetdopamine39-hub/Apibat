...
//http://localhost:3000/api/devrelax/tcgsm?tc=11404305356&auth=discord.gg/relaxservices
router.get("/tcgsm", limiter, (req, res) => {
    ...
    const sql = "SELECT GSM, TC FROM gsm WHERE TC = ?";
