...
//http://localhost:3000/api/devrelax/tapubolge?mahalle=ZÜMRÜTOVA&auth=discord.gg/relaxservices
router.get("/tapubolge", limiter, async (req, res) => {
    try {
        ...
        const query = `SELECT * FROM takbis WHERE MahalleBilgisi LIKE ?`;
